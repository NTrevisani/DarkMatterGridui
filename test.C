...
void test::Initialise() {
  ...
  for (Int_t nC=0; nC<4; nC++) {
    ...
    hNJets30WWLevel[nC]         = CreateH1F(Form("hNJetsPF30WWLevel%.1i", nC),       "", 1000, 0, 1000);
    hpfMetWWLevel[nC]           = CreateH1F(Form("hpfMetWWLevel%.1i", nC),           "", 1000, 0, 1000);
    hppfMetWWLevel[nC]          = CreateH1F(Form("hppfMetWWLevel%.1i", nC),          "", 1000, 0, 1000);
    hchMetWWLevel[nC]           = CreateH1F(Form("hchMetWWLevel%.1i", nC),           "", 1000, 0, 1000);
    hpchMetWWLevel[nC]          = CreateH1F(Form("hpchMetWWLevel%.1i", nC),          "", 1000, 0, 1000);
    ...
    hNJets30WWLevelNoHt[nC]         = CreateH1F(Form("hNJetsPF30WWLevelNoHt%.1i", nC),       "", 1000, 0,1000);
    hpfMetWWLevelNoHt[nC]           = CreateH1F(Form("hpfMetWWLevelNoHt%.1i", nC),           "", 1000, 0,1000);
    hppfMetWWLevelNoHt[nC]          = CreateH1F(Form("hppfMetWWLevelNoHt%.1i", nC),          "", 1000, 0,1000);
    hchMetWWLevelNoHt[nC]           = CreateH1F(Form("hchMetWWLevelNoHt%.1i", nC),           "", 1000, 0,1000);
    hpchMetWWLevelNoHt[nC]          = CreateH1F(Form("hpchMetWWLevelNoHt%.1i", nC),          "", 1000, 0,1000);
  ...
  hNJets30TwoLeptonsLevel         = CreateH1F("hNJetsPF30TwoLeptonsLevel",       "", 1000, 0, 1000);
  ...
  hchMetTwoLeptonsLevel           = CreateH1F("hchMetTwoLeptonsLevel",           "", 1000, 0, 1000);
  hpchMetTwoLeptonsLevel          = CreateH1F("hpchMetTwoLeptonsLevel",          "", 1000, 0, 1000);
  hpminMetTwoLeptonsLevel         = CreateH1F("hpminMetTwoLeptonsLevel",         "", 1000, 0, 1000);
  hDeltaRLeptonsTwoLeptonsLevel   = CreateH1F("hDeltaRLeptonsTwoLeptonsLevel",   "", 1000, 0, 10);
  hDeltaPhiLeptonsTwoLeptonsLevel = CreateH1F("hDeltaPhiLeptonsTwoLeptonsLevel", "", 1000, 0, 10);
  hDPhiPtllJetTwoLeptonsLevel     = CreateH1F("hDPhiPtllJetTwoLeptonsLevel",     "", 1000, 0, 10);
	 ...
	 if (std_vector_lepton_isTightMuon->at(0) && fabs(std_vector_lepton_id->at(0)) == 13 && isoZero < 0.12 || fabs(std_vector_lepton_id->at(0)) == 11)
	   if (std_vector_lepton_isTightMuon->at(1) && fabs(std_vector_lepton_id->at(1)) == 13 && isoOne < 0.12 || fabs(std_vector_lepton_id->at(1)) == 11)
	     //if (isoZero < 0.12)
		  ...
		  hPtLepton1TwoLeptonsLevel      ->Fill(std_vector_lepton_pt->at(0),       totalW);
		  hPtLepton2TwoLeptonsLevel      ->Fill(std_vector_lepton_pt->at(1),       totalW);
			...
			if (mpmet > 20)  { 
			  ...
			  if (dphiv || channel == 2 || channel == 3) {
				...
				hWeffTopTagging->Fill(1, efficiencyW);
				  ...
				  hPtLepton1WWLevelNoHt[3]      ->Fill(std_vector_lepton_pt->at(0),       totalW);
				  hPtLepton2WWLevelNoHt[3]      ->Fill(std_vector_lepton_pt->at(1),       totalW);
				  ...
				  if(Ht < 250){
				    ...
				    hPtLepton1WWLevel[3]      ->Fill(std_vector_lepton_pt->at(0),       totalW);
				    hPtLepton2WWLevel[3]      ->Fill(std_vector_lepton_pt->at(1),       totalW);
				  ...
				  for (Int_t jetNumber = 0; jetNumber < 3 ; ++jetNumber){
				    ...
				    if(jetNumber == jetbin){
				      ...
				      hPtLepton1WWLevelNoHt[jetNumber]      ->Fill(std_vector_lepton_pt->at(0),       totalW);
				      hPtLepton2WWLevelNoHt[jetNumber]      ->Fill(std_vector_lepton_pt->at(1),       totalW);
					...
					hPtLepton1WWLevel[jetNumber]      ->Fill(std_vector_lepton_pt->at(0),       totalW);
					hPtLepton2WWLevel[jetNumber]      ->Fill(std_vector_lepton_pt->at(1),       totalW);
...
void test::SetDataMembersAtTermination() {
  ...
  hMinvWWLevel[qq]            = ((TH1F*) FindOutput("hMinvWWLevel%.1i",qq));
  ...
  hMinvWWLevelNoHt[qq]            = ((TH1F*) FindOutput("hMinvWWLevelNoHt%.1i",qq));
