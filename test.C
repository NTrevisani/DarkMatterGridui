...
void test::Initialise() {
  ...
  for (Int_t nC=0; nC<4; nC++) {
    ...
    hppfMetWWLevelHtPlus[nC]          = CreateH1F(Form("hppfMetWWLevelHtPlus%.1i", nC),          "", 1000, 0, 1000);
    hchMetWWLevelHtPlus[nC]           = CreateH1F(Form("hchMetWWLevelHtPlus%.1i", nC),           "", 1000, 0, 1000);
    hpchMetWWLevelHtPlus[nC]          = CreateH1F(Form("hpchMetWWLevelHtPlus%.1i", nC),          "", 1000, 0, 1000);
    ...
    hPtWWNoBtagging[nC]         = CreateH1F(Form("hPtWWNoBtagging%.1i", nC),         "", 1000, 0, 1000);
  }
...
void test::SetDataMembersAtTermination() {
  ...
  hWmth = ((TH1F*) FindOutput("hWmth"));
  hWeffmth = ((TH1F*) FindOutput("hWeffmth"));
  hWdphill = ((TH1F*) FindOutput("hWdphill"));
  hWeffdphill = ((TH1F*) FindOutput("hWeffdphill"));
