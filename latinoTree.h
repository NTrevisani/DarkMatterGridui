...
// Mon Apr 20 12:27:27 2015 by ROOT version 5.34/23
// from TTree latino/probe_tree
// found on file: /gpfs/csic_projects/cms/trevisanin/newLatino/stepB_ppTOzh_zTO2v_hTOwwTO2l2v_13TeV.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/gpfs/csic_projects/cms/trevisanin/newLatino/stepB_ppTOzh_zTO2v_hTOwwTO2l2v_13TeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/gpfs/csic_projects/cms/trevisanin/newLatino/stepB_ppTOzh_zTO2v_hTOwwTO2l2v_13TeV.root");
      }
