...
int doTheROC(TString variable = "hTrkMetTwoLeptonsLevel", 
  ...
  //signal files
  TFile *fsig = new TFile("rootFiles/AllJet/OF/" + scaleXS + "/" + sampleName  + ".root","read");
...
void ROC(TString printMode = "png", TString sample = "Dark1", TString XSscale = "1"){
  ...
  while (getline(inFile,line)){
    ...
    doTheROC(var, sample, cutType, rightBound, printMode, tagText, XSscale);
  } 
